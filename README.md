...
`bryanunitek/UniSaaS.UniCORE.ClamAV` is the **ClamAV** family member: SaaS-deployment-shape public gift surface. Documentation today; source code at certification.

**Family purpose:** Open-source antivirus engine — email + file attachment scanning for UniCORE.GVB.

**Deployment shape:** This is the **SaaS-shape** member of the family. It tracks the same upstream codebase as [`UniCORE.ClamAV`](https://github.com/bryanunitek/UniCORE.ClamAV) (on-prem shape) but carries SaaS-specific configuration, multi-tenant isolation patterns, and cloud-native deployment artefacts.

---

## Upstream

- **Upstream project:** https://github.com/Cisco-Talos/clamav
...
UniCORE.ClamAV is published as a **four-repo family**:

- `bryanunitek/UniCORE.ClamAV` — public on-prem-deployment-shape gift surface
- `bryanunitek/UniSaaS.UniCORE.ClamAV` — public SaaS-deployment-shape gift surface ← **this repo**
- `bryanunitek/UniCORE.ClamAV-Claw` (private) — on-prem-shape working repository
- `bryanunitek/UniSaaS.UniCORE.ClamAV-Claw` (private) — SaaS-shape working repository
...
- **Public discussion:** [GitHub Discussions](https://github.com/bryanunitek/UniSaaS.UniCORE.ClamAV/discussions)
